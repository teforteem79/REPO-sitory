...
# Організуйте діалоговий режим із вводом з клавіатури, який дозволяє робити
# такі операції:
# a. Вивести весь фрейм.
# b. Додавати елементи до фрейму.
# c. Відсортувати фрейм за заданим атрибутом.
...
def sortByAttribute(zrostanna = None):
    while True:
        choice = input(f'''
