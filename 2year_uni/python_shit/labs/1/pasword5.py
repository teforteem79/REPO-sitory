                ...
                for l in range(len(char6)):
                    for m in range(len(char6)):
                        for n in range(len(char6)):
                            ...
                            temp_hash_obj = hashlib.blake2s(temp_pass.encode('utf-8'))
                            digest = temp_hash_obj.hexdigest()
                            tries += 1
...
# findPassSixth()
test_hash_obj = hashlib.blake2s(test_password.encode('utf-8'))
